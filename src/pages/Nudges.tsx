...
const initialNudges = [
  { id: 1, message: "Try using Claude to rewrite your last client email — compare the results with your original.", category: "Experiment", date: "Today", dismissed: false },
  { id: 2, message: "You haven't used Midjourney yet. Try generating a hero image for your next blog post.", category: "Explore", date: "Yesterday", dismissed: false },
  { id: 3, message: "Your content workflows average 25 min. Try batching similar prompts to cut that in half.", category: "Optimize", date: "Mar 28", dismissed: false },
  { id: 4, message: "Create a reusable prompt template for your weekly reports — you've done this task 4 times.", category: "Automate", date: "Mar 26", dismissed: false },
  { id: 5, message: "Review your latest workflow results and rate them to improve future suggestions.", category: "Feedback", date: "Mar 24", dismissed: false },
];
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs px-2 py-0.5 rounded-full bg-primary/10 text-primary font-medium">{nudge.category}</span>
